...
category_dropdown = ttk.Combobox(input_frame, textvariable=category_var, values=["Food", "Transport", "Shopping", "Utilities", "Others"])
...
expense_listbox = tk.Listbox(frame, width=50, height=15, yscrollcommand=scrollbar.set)
